//
//  Pregunta1ExponecialViewController.swift
...
class Pregunta1ExponecialViewController: UIViewController {
    ...
    var arregloRespuestas : [UIImage] = [UIImage(named: "e1")!,UIImage(named: "e2")!,UIImage(named: "e3")!,UIImage(named: "e4")!,UIImage(named: "e5")!,UIImage(named: "e6")!,UIImage(named: "e7")!,UIImage(named: "e8")!]
